...
git branch -M main
git remote add origin git@github.com:NLeSC/dales2zarr
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/NLeSC/repositories/new](https://github.com/organizations/NLeSC/repositories/new)
and create a new repository named `dales2zarr` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/NLeSC/dales2zarr/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
